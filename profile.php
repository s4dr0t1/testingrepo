				...
				<div class="col-lg-12 mx-auto mbr-form form-col md-pb">
					<div class="form-wrap" data-form-type="formoid">
						<form action="process_update_profile.php" method="POST"
							class="mbr-form form-with-styler col-lg-6 mx-auto" data-form-title="Form Name">

							<div class="dragArea form-row">
								<div class="col-sm-12 form-group">
									<label>Username</label>
									<input type="text" name="user[username]" placeholder="Username"
										value="<?= $userInfo['username'] ?>" class="form-control display-7"
										required="required" />
								</div>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="password">
									...
									<input type="password" name="user[password]" placeholder="New Password"
										data-form-field="password" class="form-control display-7" value=""
										id="password-formbuilder-1o">
								</div>
								<div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="password1">
									...
									<input type="password" name="user[confirm_password]" placeholder="Confirm Password"
										data-form-field="password" class="form-control display-7" value=""
										id="password1-formbuilder-1o">
								</div>
								<div style="clear: both"></div><br />

								<div class="mbr-section-btn">
									<button style="display: inline-block;" type="submit"
										class="btn btn-sm btn-secondary display-7">Save</button>
								</div>
