	...
	<nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
		<div class="container">
			<div class="navbar-brand">
				...
				<span class="navbar-caption-wrap"><a class="navbar-caption text-info display-2" href="index.php">EXPENSE
						Tracker&nbsp;</a></span>
			</div>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
                    ...
                    if (ss()) {
                    ?>
					<li class="nav-item"><a class="nav-link link text-warning display-7" href="index.php">Dashboard</a>
					</li>
					<?php
                    }
                    ?>
					<li class="nav-item"><a class="nav-link link text-warning display-7"
							href="manage_expenses.php">Expenses</a></li>
					<li class="nav-item"><a class="nav-link link text-warning display-7"
							href="manage_categories.php">Categories</a></li>
					<li class="nav-item"><a class="nav-link link text-warning display-7" href="profile.php">My
							Profile</a></li>
					<li class="nav-item"><a class="nav-link link text-warning display-7" href="charts.php">Charts</a>
					</li>
					<?php
                    if (!ss()) {
                    ?>
                    ...
                    ?>
					<li class="nav-item"><a class="nav-link link text-warning display-7" href="logout.php">Logout</a>
					</li>
					<?php
                    }
                    ?>
